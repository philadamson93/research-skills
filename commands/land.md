...
Summarize Phases 1–2 as bullets (landable? review-status? behind main? conflict findings + merge order?), then **gate the write-to-main with an `AskUserQuestion`** — structured options, never inline yes/no, never silent:
