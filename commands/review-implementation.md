...
- Check tests: did the plan call for test layers / migration tests / new test files? Are they present and asserting the spec'd contracts (not just smoke-passing)?
